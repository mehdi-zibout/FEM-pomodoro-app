...
function Cercle({
  ...
  return (
    ...
    >
      <div
        className='box rounded-full tablet:w-[25.625rem] tablet:h-[25.625rem] w-[18.75rem] h-[18.75rem] bg-gradient-to-br  from-[#0E112A] to-[#2E325A] flex justify-center items-center'
